...
class EMNISTLines(BaseDataModule):
    ...
    def data_filename(self):
        return PROCESSED_DATA_DIRNAME / (
            f"ml_{self.max_length}_o{self.min_overlap:f}_{self.max_overlap:f}_ntr{self.num_train}_"
            f"ntv{self.num_val}_nte{self.num_test}_{self.with_start_end_tokens}.h5"
        )
